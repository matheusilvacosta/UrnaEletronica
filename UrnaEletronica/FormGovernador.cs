...
{
    public partial class FormGovernador : Form
    {
        private Urna urna;
        ...
        public FormGovernador(Urna urna)
        {
            InitializeComponent();
            this.urna = urna;
            controleConfirma = 0;
        ...
        private void FormGovernador_Load(object sender, EventArgs e)
        {
        ...
        private void buttonConfirma_Click(object sender, EventArgs e)
        {
            if (textCandidato.Text != "" && (textCandidato.Text).Length == 2)
            {
                if (controleConfirma == 0)
                {
                    ...
                    candidato = urna.verificaCandidato(textCandidato.Text, "Governador");
                ...
                else
                {
                    if (candidato != null)
                    {
                        urna.confirmaCandidato(textCandidato.Text, "Governador");

                        this.Hide();
                        Form f = new FormPresidente(urna);
            ...
            {
                MessageBox.Show("Digitos Insuficientes, utilize 2 digitos para GOVERNADOR");
            }
